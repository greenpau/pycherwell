...
class TeamResponse(object):
    ...
    def __init__(self, description=None, email_alias=None, fields=None, image=None, name=None, team_id=None, team_type=None, error_code=None, error_message=None, has_error=None):  # noqa: E501
