...
class SearchResultsResponse(object):
    ...
    def __init__(self, business_objects=None, has_prompts=None, links=None, prompts=None, search_results_fields=None, simple_results=None, total_rows=None, error_code=None, error_message=None, has_error=None):  # noqa: E501
