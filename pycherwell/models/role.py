...
class Role(object):
    ...
    def __init__(self, browser_client_custom_view_id=None, business_object_exclude_list=None, culture=None, description=None, mobile_client_custom_view_id=None, primary_bus_ob_id=None, role_id=None, role_name=None, smart_client_custom_view_id=None):  # noqa: E501
