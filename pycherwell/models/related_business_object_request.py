...
class RelatedBusinessObjectRequest(object):
    ...
    def __init__(self, all_fields=None, custom_grid_id=None, fields_list=None, filters=None, page_number=None, page_size=None, parent_bus_ob_id=None, parent_bus_ob_rec_id=None, relationship_id=None, sorting=None, use_default_grid=None):  # noqa: E501
