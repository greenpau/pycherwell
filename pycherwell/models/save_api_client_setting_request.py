...
class SaveApiClientSettingRequest(object):
    ...
    def __init__(self, allow_anonymous_access=None, api_access_is_enabled=None, create_new_client_key=None, culture=None, description=None, name=None, refresh_token_lifespan_minutes=None, stand_in_key=None, token_lifespan_minutes=None):  # noqa: E501
