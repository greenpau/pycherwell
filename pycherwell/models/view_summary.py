...
class ViewSummary(object):
    ...
    def __init__(self, group_summaries=None, image=None, is_part_of_view=None, bus_ob_id=None, display_name=None, group=None, lookup=None, major=None, name=None, supporting=None):  # noqa: E501
