...
class SearchFolder(object):
    ...
    def __init__(self, association=None, child_folders=None, child_items=None, folder_id=None, folder_name=None, links=None, localized_scope_name=None, parent_folder_id=None, scope=None, scope_owner=None):  # noqa: E501
