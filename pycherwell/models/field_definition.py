...
class FieldDefinition(object):
    ...
    def __init__(self, auto_fill=None, calculated=None, category=None, decimal_digits=None, description=None, details=None, display_name=None, enabled=None, field_id=None, has_date=None, has_time=None, is_full_text_searchable=None, maximum_size=None, name=None, read_only=None, required=None, type=None, type_localized=None, validated=None, whole_digits=None):  # noqa: E501
