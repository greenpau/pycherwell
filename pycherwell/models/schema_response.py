...
class SchemaResponse(object):
    ...
    def __init__(self, bus_ob_id=None, field_definitions=None, first_rec_id_field=None, grid_definitions=None, name=None, rec_id_fields=None, relationships=None, state_field_id=None, states=None, error_code=None, error_message=None, has_error=None):  # noqa: E501
