...
class Attachment(object):
    ...
    def __init__(self, attached_bus_ob_id=None, attached_bus_ob_rec_id=None, attachment_file_id=None, attachment_file_name=None, attachment_file_type=None, attachment_id=None, attachment_type=None, bus_ob_id=None, bus_ob_rec_id=None, comment=None, created=None, display_text=None, links=None, owner=None, scope=None, scope_owner=None, type=None):  # noqa: E501
