...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self, host="https://demo.cherwellondemand.com",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("pycherwell")
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://{customerId}.cherwellondemand.com",
                'description': "No description provided",
                'variables': {
                    'customerId': {
                        'description': "Customer ID assigned by Cherwell",
                        'default_value': "demo",
                        }
                    }
            }
